...
@Composable
fun EditarOrientacaoScreen(
    viewModel: EditarOrientacaoViewModel,
    onNavigateBack: () -> Unit,
    onOrientacaoUpdated: () -> Unit
) {
    val uiState by viewModel.uiState.collectAsStateWithLifecycle()

    EditarOrientacaoScreenContent(
        uiState = uiState,
...
@Composable
private fun EditarOrientacaoScreenContent(
    uiState: EditarOrientacaoUiState,
    ...
    Scaffold(
        topBar = {
            AguiaTopBar(
                title = stringResource(R.string.editar_orientacao_title),
        ...
        when {
            ...
            uiState.orientacaoOriginal == null -> {
                Box(
                    modifier = Modifier
                        .fillMaxSize()
                        .padding(paddingValues),
                    ...
                    Text(
                        text = stringResource(R.string.error_orientacao_not_found),
                ...
                Column(
                    ...
                    OutlinedTextField(
                        ...
                        label = { Text(stringResource(R.string.orientacao_titulo_label)) },
                        placeholder = { Text(stringResource(R.string.orientacao_titulo_placeholder)) },
                        singleLine = true,
                    ...
                    OutlinedTextField(
                        ...
                        modifier = Modifier
                            .fillMaxWidth()
                            .height(120.dp),
                        label = { Text(stringResource(R.string.orientacao_descricao_label)) },
                        placeholder = { Text(stringResource(R.string.orientacao_descricao_placeholder)) },
                        shape = MaterialTheme.shapes.small,
                    ...
                    ExposedDropdownMenuBox(
                        ...
                        OutlinedTextField(
                            ...
                            modifier = Modifier
                                ...
                                .fillMaxWidth(),
                            readOnly = true,
                            label = { Text(stringResource(R.string.orientacao_categoria_label)) },
                            trailingIcon = {
                    ...
                    Column {
                        Row(
                            ...
                            Text(
                                text = stringResource(R.string.orientacao_prioridade_label),
                        ...
                        Row(
                            ...
                            Text(
                                text = stringResource(R.string.prioridade_critica),
                                style = MaterialTheme.typography.labelSmall,
                                color = MaterialTheme.colorScheme.outline
                            )
                            Text(
                                text = stringResource(R.string.prioridade_baixa),
                                style = MaterialTheme.typography.labelSmall,
                                color = MaterialTheme.colorScheme.outline
                            )
                        }
                    ...
                    Button(
                        ...
                        Text(
                            ...
                            else stringResource(R.string.salvar_alteracoes),
                            color = if (!uiState.isSaving && isFormValid) {
                    ...
                    if (!isFormValid && !uiState.isSaving) {
                        Text(
                            text = stringResource(R.string.campos_obrigatorios),
...
@Composable
private fun EditarOrientacaoScreenPreview() {
    InovagabTheme {
        EditarOrientacaoScreenContent(
            uiState = EditarOrientacaoUiState(
                isLoading = false,
                titulo = "Reduzir custos operacionais",
                descricao = "Meta de redução de 15% até dezembro",
